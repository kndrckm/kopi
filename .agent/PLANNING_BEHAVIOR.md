...
2.  **Environment Preference**: Always use **port 1000** for local testing (e.g., `npx serve . -l 1000`) to match Supabase redirect configurations.
3.  **Present two execution options**:
...
4.  **Ask**: "Would you like me to proceed sequentially, or use the **Parallel Multi-Tasking Workflow** to speed up the process?"
